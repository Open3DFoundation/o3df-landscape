# Open 3D Foundation Landscape

This repository contains the data files and images required to generate the [Open 3D Foundation landscape](https://o3df.landscape2.io). The software that generates it can be found at the [cncf/landscape2](https://github.com/cncf/landscape2) repository. Please see its [README file](https://github.com/cncf/landscape2#landscape2) for more information about how it works.
